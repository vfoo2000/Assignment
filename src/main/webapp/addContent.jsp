...
<body>
    <div class="all-page">
        ...
        <div class="container p-5">
            ...
            <c:if test="${not empty addMessageSubmit}">
                <div class="border rounded bg-success text-white mt-3 p-2 ps-3">
                        ${addMessageSubmit}
                </div>
            </c:if>
            <div class="border rounded-top bg-light mt-3 p-1 ps-3 ">Content Form Elements</div>
            <f:form class="border rounded-bottom p-3" action="${pageContext.request.contextPath}/addContent" modelAttribute="newContent" method="POST">
                <div class="mb-3">
                    <label class="form-label"><b>Title</b></label>
                    <f:input type="text" path="title" class="form-control" placeholder="Enter the title" maxlength="50"/>
                </div>
                <div class="mb-3">
                    <label class="form-label"><b>Brief</b></label>
                    <f:textarea path="brief" class="form-control"/>
                </div>
                <div class="mb-3">
                    <label class="form-label"><b>Content</b></label>
                    <f:textarea path="content" class="form-control h-150px"/>
                </div>
                <div>
